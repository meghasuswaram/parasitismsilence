...
qi = [0.1:0.01:1];% percentage of females
fmax = 3;
qioutN = zeros(1,91);
qioutzbar = zeros(1,91);
...
c = qi;
sz = 75;
scatter(qi,qioutzbar,sz,c,'filled','MarkerEdgeColor','black')
...
d = qi;
sz = 75;
scatter(qi,qioutN,sz,d,'d','filled','MarkerEdgeColor','black')
colormap(flipud(gray))
xlabel('Proportion of parasitoid females')
